...
use BlackCat\Database\Packages\SystemJobs\Dto\SystemJobDto as Dto;
use BlackCat\Database\Packages\SystemJobs\Mapper\SystemJobDtoMapper as RowMapper;
...
class SystemJobRepository implements SystemJobRepositoryInterface, RepoContract, KeysetRepoContract
{
use OrderByTools, PkTools, RepositoryHelpers;
     ...
     */
    protected function def(): string { return \BlackCat\Database\Packages\SystemJobs\Definitions::class; }
    ...
    public function upsertMany(array $rows): int {
        ...
        if ($helperKeys && class_exists(\BlackCat\Database\Support\BulkUpsertHelper::class)) {
          $bulk = new \BlackCat\Database\Support\BulkUpsertHelper($this->db, \BlackCat\Database\Packages\SystemJobs\Definitions::class);
