...
use BlackCat\Database\Packages\SystemJobs\Repository\SystemJobRepositoryInterface;
use BlackCat\Database\Packages\SystemJobs\Repository\SystemJobRepository as GeneratedRepository;
...
{
  private SystemJobRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof SystemJobRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected SystemJobRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\SystemJobs\Dto\SystemJobDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\SystemJobs\Dto\SystemJobDto|null { return $this->repo->getById($id, $asDto); }
