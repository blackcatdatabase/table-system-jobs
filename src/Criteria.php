...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'job_type', 'payload', 'status', 'retries', 'scheduled_at', 'started_at', 'finished_at', 'error', 'unique_key_hash', 'unique_key_version', 'locked_until', 'locked_by', 'created_at', 'updated_at', 'version' ];
    }
    ...
    {
        $x = [ 'id', 'job_type', 'status', 'retries', 'scheduled_at', 'started_at', 'finished_at', 'error', 'unique_key_hash', 'unique_key_version', 'locked_until', 'locked_by', 'created_at', 'updated_at', 'version' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\SystemJobs\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\SystemJobs\Definitions::softDeleteColumn();
