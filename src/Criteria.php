 ...
 * - whitelist filtrů: [ 'id', 'job_type', 'payload', 'status', 'retries', 'scheduled_at', 'started_at', 'finished_at', 'error', 'created_at', 'updated_at', 'version' ]
 * - whitelist LIKE:   [ 'job_type', 'status', 'error' ]
 * Podporované tvary:
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        $allowed = array_fill_keys([ 'id', 'job_type', 'payload', 'status', 'retries', 'scheduled_at', 'started_at', 'finished_at', 'error', 'created_at', 'updated_at', 'version' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'job_type', 'payload', 'status', 'retries', 'scheduled_at', 'started_at', 'finished_at', 'error', 'created_at', 'updated_at', 'version' ], true);
            $parts = [];
