...
namespace BlackCat\Database\Packages\SystemJobs\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO SystemJobDto:
...
final class SystemJobDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'retries', 'version' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [ 'payload' ];
    /** @var string[] */
    private const DATE_COLS   = [ 'scheduled_at', 'started_at', 'finished_at', 'locked_until', 'created_at', 'updated_at' ];
    /** @var string[] */
     ...
     * @return SystemJobDto
     */
    public static function fromRow(array $row): SystemJobDto
    {
        /** @var SystemJobDto */
    ...
    public static function fromRowOrNull(?array $row): ?SystemJobDto
    {
     ...
     *
     * @param SystemJobDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(SystemJobDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(SystemJobDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(SystemJobDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,SystemJobDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,SystemJobDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(SystemJobDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,SystemJobDto>
     */
