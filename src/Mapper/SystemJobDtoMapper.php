...
final class SystemJobDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'job_type' => 'jobType', 'scheduled_at' => 'scheduledAt', 'started_at' => 'startedAt', 'finished_at' => 'finishedAt', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt' ];
    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'retries' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [ 'payload' ];
    /** @var string[] */
    private const DATE_COLS   = [ 'scheduled_at', 'started_at', 'finished_at', 'created_at', 'updated_at' ];
    /** @var string[] */
    private const BIN_COLS    = [];
    /** @var string[] */
    private const NULLABLE    = [ 'id', 'payload', 'scheduled_at', 'started_at', 'finished_at', 'error' ];
