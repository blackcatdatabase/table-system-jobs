...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'job_type', 'payload', 'status', 'retries', 'scheduled_at', 'started_at', 'finished_at', 'error', 'unique_key_hash', 'unique_key_version', 'locked_until', 'locked_by', 'created_at', 'updated_at', 'version' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ '64' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'retries', 'version' ]; }
