...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'job_type', 'payload', 'status', 'retries', 'scheduled_at', 'started_at', 'finished_at', 'error', 'created_at', 'updated_at', 'version' ]; }
