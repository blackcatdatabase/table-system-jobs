...
- Pkg folder: [packages\system-jobs](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\system-jobs)
...
graph LR
  ...
  system_jobs["system_jobs"]:::center
```
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package system-jobs -Apply
