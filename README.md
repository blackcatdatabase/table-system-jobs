...
> Lineage: 0 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 4 · Changelog: fresh
...
| Pkg folder | [packages/system-jobs](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/system-jobs) | Repo location |
...
- job_type (key)
- unique_key_hash (key)
- unique_key_version (key)

## Usage
```bash
# Install/upgrade schema
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package system-jobs -Apply
